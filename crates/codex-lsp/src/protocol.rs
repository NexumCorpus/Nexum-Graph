...
/// Lock annotation published through `codex/activeLocks`.
...
/// Notification payload for `codex/activeLocks`.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
#[serde(rename_all = "camelCase")]
...
/// Agent-intent annotation published through `codex/agentIntent`.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
#[serde(rename_all = "camelCase")]
...
/// Notification payload for `codex/agentIntent`.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
#[serde(rename_all = "camelCase")]
...
/// Validation issue summary published through `codex/validationStatus`.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
#[serde(rename_all = "camelCase")]
...
/// Notification payload for `codex/validationStatus`.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
#[serde(rename_all = "camelCase")]
...
/// Event summary published through `codex/eventStream`.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
#[serde(rename_all = "camelCase")]
...
/// Custom request trait for `codex/semanticDiff`.
...
impl lsp_types::request::Request for CodexSemanticDiff {
    ...
    const METHOD: &'static str = "codex/semanticDiff";
}

/// Custom notification trait for `codex/activeLocks`.
pub enum CodexActiveLocks {}

impl lsp_types::notification::Notification for CodexActiveLocks {
    type Params = ActiveLocksParams;
    const METHOD: &'static str = "codex/activeLocks";
}

/// Custom notification trait for `codex/agentIntent`.
pub enum CodexAgentIntent {}

impl lsp_types::notification::Notification for CodexAgentIntent {
    type Params = AgentIntentParams;
    const METHOD: &'static str = "codex/agentIntent";
}

/// Custom notification trait for `codex/validationStatus`.
...
impl lsp_types::notification::Notification for CodexValidationStatus {
    ...
    const METHOD: &'static str = "codex/validationStatus";
}

/// Custom notification trait for `codex/eventStream`.
pub enum CodexEventStream {}

impl lsp_types::notification::Notification for CodexEventStream {
    type Params = EventStreamParams;
    const METHOD: &'static str = "codex/eventStream";
}
