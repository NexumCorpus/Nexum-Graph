...
use codex_core::{ChangeKind, ConflictKind, ConflictReport, SemanticDiff, Severity};
use std::fmt::Write;
...
use codex_core::SemanticUnit;
use codex_core::{LockResult, ValidationReport};
use codex_eventlog::{RollbackOutcome, SemanticEvent};
...
///   Suggestion: run `codex lock alice validate write` first
///
